...
TIME=$(date '+%d %b %Y')
REPO="https://raw.githubusercontent.com/namydeveloper/hah/main/"
TIMES="10"
CHATID="5651317408"
...
echo -e "  Auther : ${green}Namy Tunneling® ${NC}${YELLOW}(${NC} ${green} Namy ${NC}${YELLOW})${NC}"
...
apete_apdet() {
    ...
    wget raw.githubusercontent.com/namydeveloper/hah/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
...
Documentation=https://github.com/namydeveloper
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/namydeveloper/izin/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/namydeveloper/izin/main/ip | grep $ipsaya | awk '{print $3}')
